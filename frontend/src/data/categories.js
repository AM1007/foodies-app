const categories = [
  ...
  { name: 'Desserts', image: '/image/categories/Desserts_1x-min.png' },
  ...
  { name: 'Pork', image: '/image/categories/Pork_1x-min.png' },
  { name: 'Seafood', image: '/image/categories/Seafood_1x-min.png' },
